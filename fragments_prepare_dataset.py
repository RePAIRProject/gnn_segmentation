...
if __name__ == '__main__':
    ...
    # SAVE 
    print("Saving..")
    with open(os.path.join('data', f'group_{group}_fragments_{task}_training_set_from_{dataset_name}'), 'wb') as file: 
        pickle.dump(train_dataset, file)
    with open(os.path.join('data', f'group_{group}_fragments_{task}_test_set_from_{dataset_name}'), 'wb') as file: 
